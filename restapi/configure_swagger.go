...
//go:generate swagger generate server --target ../../swagger-test --name Swagger --spec ../swagger.yml
...
func configureAPI(api *operations.SwaggerAPI) http.Handler {
	...
	api.GetFileCsvHandler = operations.GetFileCsvHandlerFunc(func(params operations.GetFileCsvParams) middleware.Responder {
		return getFile(params.HTTPRequest)
	})
