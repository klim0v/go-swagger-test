...
func NewSwaggerAPI(spec *loads.Document) *SwaggerAPI {
	return &SwaggerAPI{
		...
		GetFileCsvHandler: GetFileCsvHandlerFunc(func(params GetFileCsvParams) middleware.Responder {
			return middleware.NotImplemented("operation GetFileCsv has not yet been implemented")
		}),
...
type SwaggerAPI struct {
	...
	// GetFileCsvHandler sets the operation handler for the get file csv operation
	GetFileCsvHandler GetFileCsvHandler
...
func (o *SwaggerAPI) Validate() error {
	...
	if o.GetFileCsvHandler == nil {
		unregistered = append(unregistered, "GetFileCsvHandler")
	}
...
func (o *SwaggerAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/file.csv"] = NewGetFileCsv(o.context, o.GetFileCsvHandler)
